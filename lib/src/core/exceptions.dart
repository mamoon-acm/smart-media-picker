...
class MediaSelectionCancelledException implements Exception {
  ...
  MediaSelectionCancelledException([
    this.message = 'User cancelled media selection.',
  ]);
...
class MediaSizeExceededException implements Exception {
  final String message;
  MediaSizeExceededException([
    this.message = 'Selected media exceeds the maximum size limit.',
  ]);
...
class MediaProcessingException implements Exception {
  ...
  MediaProcessingException([
    this.message = 'Failed to process the media file.',
  ]);
